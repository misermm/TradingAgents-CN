...
"""
        ...
        analysis_modules = [
            ...
            ('warren_buffett_report', '🎩 巴菲特', '价值投资大师分析'),
            ('peter_lynch_report', '🎩 彼得·林奇', '成长投资大师分析'),
            ('ben_graham_report', '🎩 格雷厄姆', '安全边际大师分析'),
            ('charlie_munger_report', '🎩 芒格', '理性投资大师分析'),
            ('cathie_wood_report', '🎩 凯瑟琳·伍德', '颠覆式创新大师分析'),
            ('bill_ackman_report', '🎩 阿克曼', '激进投资大师分析'),
            ('phil_fisher_report', '🎩 费舍尔', '长期持有大师分析'),
            ('stanley_druckenmiller_report', '🎩 德鲁肯米勒', '宏观交易大师分析'),
            ('aswath_damodaran_report', '🎩 达莫达兰', '估值大师分析'),
            ('michael_burry_report', '🎩 布瑞', '深度价值大师分析'),
            ('mohnish_pabrai_report', '🎩 帕伯莱', '套利投资大师分析'),
            ('nassim_taleb_report', '🎩 塔勒布', '黑天鹅理论大师分析'),
            ('rakesh_jhunjhunwala_report', '🎩 朱朱瓦拉', '印度价值投资大师分析'),
            ('master_consensus_report', '📊 大师共识', '所有大师的综合共识分析'),
