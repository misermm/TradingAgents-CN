...
from app.services.simple_analysis_service import create_analysis_config, get_provider_by_model_name_sync
    ...
    async def _execute_single_analysis_async(self, task: AnalysisTask):
        ...
        try:
            ...
            try:
                ...
                provider = get_provider_by_model_name_sync(model_name)
    ...
    async def submit_single_analysis(
        ...
        try:
            ...
            if not getattr(params, 'quick_analysis_model', None):
                params.quick_analysis_model = effective_settings.get("quick_analysis_model") or unified_config.get_quick_analysis_model()
            if not getattr(params, 'deep_analysis_model', None):
                params.deep_analysis_model = effective_settings.get("deep_analysis_model") or unified_config.get_deep_analysis_model()
