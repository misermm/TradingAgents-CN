...
class RedisProgressTracker:
    ...
    def _get_analyst_step_info(self, analyst: str) -> Dict[str, str]:
        ...
        mapping = {
            ...
            'warren_buffett': {"name": "🎩 巴菲特", "description": "价值投资大师：护城河+安全边际+能力圈分析"},
            'peter_lynch': {"name": "🎩 彼得·林奇", "description": "成长投资大师：六种分类+PEG+翻番股分析"},
            'ben_graham': {"name": "🎩 格雷厄姆", "description": "价值投资之父：量化筛选+安全边际+NCAV分析"},
            'charlie_munger': {"name": "🎩 芒格", "description": "理性投资大师：反向思考+多元思维模型分析"},
            'cathie_wood': {"name": "🎩 凯瑟琳·伍德", "description": "颠覆式创新大师：5年视野+技术融合分析"},
            'bill_ackman': {"name": "🎩 阿克曼", "description": "激进投资大师：集中投资+维权价值分析"},
            'phil_fisher': {"name": "🎩 费舍尔", "description": "长期成长大师：十五要点+闲聊法分析"},
            'stanley_druckenmiller': {"name": "🎩 德鲁肯米勒", "description": "宏观交易大师：宏观驱动+不对称风险收益分析"},
            'aswath_damodaran': {"name": "🎩 达莫达兰", "description": "估值大师：故事+数字+内在价值分析"},
            'michael_burry': {"name": "🎩 布瑞", "description": "逆向投资大师：深度价值+风险错配分析"},
            'mohnish_pabrai': {"name": "🎩 帕伯莱", "description": "丹霍投资大师：低风险+高不确定收益分析"},
            'nassim_taleb': {"name": "🎩 塔勒布", "description": "黑天鹅风险大师：脆弱性+反脆弱性分析"},
            'rakesh_jhunjhunwala': {"name": "🎩 朱朱瓦拉", "description": "新兴市场成长大师：长期复利+市场结构分析"},
        }
