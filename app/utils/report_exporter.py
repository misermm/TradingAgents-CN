...
class ReportExporter:
    ...
    def generate_markdown_report(self, report_doc: Dict[str, Any]) -> str:
        ...
        module_titles = {
            ...
            "warren_buffett_report": "🎩 巴菲特",
            "peter_lynch_report": "🎩 彼得·林奇",
            "ben_graham_report": "🎩 格雷厄姆",
            "charlie_munger_report": "🎩 芒格",
            "cathie_wood_report": "🎩 凯瑟琳·伍德",
            "bill_ackman_report": "🎩 阿克曼",
            "phil_fisher_report": "🎩 费舍尔",
            "stanley_druckenmiller_report": "🎩 德鲁肯米勒",
            "aswath_damodaran_report": "🎩 达莫达兰",
            "michael_burry_report": "🎩 布瑞",
            "mohnish_pabrai_report": "🎩 帕伯莱",
            "nassim_taleb_report": "🎩 塔勒布",
            "rakesh_jhunjhunwala_report": "🎩 朱朱瓦拉",
            "master_consensus_report": "📊 大师共识",
