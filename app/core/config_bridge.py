...
def bridge_config_to_env():
    ...
    try:
        ...
        use_mongodb_storage = str(settings.USE_MONGODB_STORAGE).lower()
        ...
        mongodb_db_name = settings.MONGODB_DATABASE or settings.MONGO_DB
        ...
        try:
            ...
            # 调试：检查环境变量
            use_mongodb = str(settings.USE_MONGODB_STORAGE).lower()
            mongodb_conn = settings.MONGO_URI
            mongodb_db = settings.MONGODB_DATABASE or settings.MONGO_DB
